  ...
  return (
    <div className="container">
      <div className="grid gap-8">
        <div className="flex flex-row justify-between px-[20px] pt-[76px] items-baseline">
          <div>
            <p className=" text-[28px] font-bold ">
              Aries, Welcome to Gdooo
            </p>
          </div>
          <div>
            <svg
        ...
        <div className=" flex gap-[25.67px] px-5 justify-between h-[94px]">
          <div className="grid items-center gap-3 ">
            <button className="purple-box-shadow bg-[#9F8CF0] h-[68px] w-[68px] rounded-xl flex justify-center items-center">
              <svg
                width="29"
                height="26"
                viewBox="0 0 29 26"
            ...
            <p className=" text-center text-xs font-normal ">Check in</p>
          </div>
          <div className="grid justify-center gap-3">
            ...
            <p className=" text-xs font-normal text-center">Shop Now</p>
          </div>
          <div className="grid justify-center gap-3">
            <button className="purple-box-shadow bg-[#9F8CF0] h-[68px] w-[68px] rounded-xl flex justify-center items-center">
              <svg
            ...
            <p className=" text-xs font-normal text-center">Wallet</p>
          </div>
          <div className="grid justify-center gap-3">
            <button className="purple-box-shadow bg-[#9F8CF0] h-[68px] w-[68px] rounded-xl flex justify-center items-center">
              <svg
            ...
            <p className=" text-xs font-normal text-center">Membership</p>
          </div>
        </div>
